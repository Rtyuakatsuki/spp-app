<?php 
$koneksi = mysqli_connect('localhost', 'root', '', 'muda_spp');
...
if (isset($_POST['go'])) {
  $cari = $_POST['cari'];
  $siswa = mysqli_query($koneksi, "SELECT * FROM tb_prodi WHERE nama LIKE '%".$cari."%'");
}else{
  $siswa = mysqli_query($koneksi, "SELECT * FROM tb_prodi LIMIT $halaman_awal, $batas");
}
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label>Program Studi</label>
                      <input class="form-control" type="text" name="prodi" value="<?=$pro['prodi'];?>">
                    </div>
